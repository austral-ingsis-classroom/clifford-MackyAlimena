...
class CommandTests {
  ...
  void givenCdAndPwdCommands_whenExecuted_thenCorrectDirectoryShown() {
    ...
    assertEquals(
        List.of("'myfolder' directory created", "moved to directory 'myfolder'", "/myfolder"),
        result);
  }
  ...
  void givenRmCommandOnFile_whenExecuted_thenFileRemoved() {
    ...
    assertEquals(List.of("'file.txt' file created", "'file.txt' removed"), result);
  }
  ...
  void givenRmRecursiveOnFolder_whenExecuted_thenFolderRemoved() {
    ...
    assertEquals(List.of("'myfolder' directory created", "'myfolder' removed"), result);
  }
}
